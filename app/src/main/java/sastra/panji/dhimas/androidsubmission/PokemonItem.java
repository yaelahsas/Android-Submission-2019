...
public class PokemonItem {
    ...
    public static String[][] dt_pokemon = new String[][]{
            ...
            {"Charmander", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/004.png","Fire","","Api yang membakar di ujung ekornya merupakan indikasi dari emosinya. Api bergetar ketika Charmander menikmati dirinya sendiri. Jika Pokemon menjadi marah, nyala api menyala dengan sangat hebat."},
            {"Charmeleon", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/005.png","Fire","","Charmeleon tanpa ampun menghancurkan musuh menggunakan cakar yang tajam. Jika bertemu dengan musuh yang kuat, itu berubah menjadi agresif. Dalam keadaan bersemangat ini, nyala di ujung ekornya menyala dengan warna putih kebiruan."},
            ...
            {"Squirtle", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/007.png","Water","","Squirtle shell tidak hanya digunakan untuk perlindungan. Bentuknya yang bulat dan lekukan di permukaannya membantu meminimalkan resistansi dalam air, memungkinkan Pokémon ini berenang dengan kecepatan tinggi."},
            {"Wartotle", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/008.png","Water","","Ekornya besar dan ditutupi bulu yang tebal dan kaya. Ekor menjadi semakin dalam warna seiring bertambahnya usia Wartortle. Goresan pada cangkangnya adalah bukti ketangguhan Pokemon ini sebagai seorang pejuang"},
            {"Blastoise", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/009.png","Water","","Blastoise memiliki semburan air yang menonjol dari cangkangnya. Semburan air sangat akurat. Mereka dapat menembakkan peluru air dengan akurasi yang cukup untuk menyerang kaleng kosong dari jarak lebih dari 160 kaki."},
            {"Caterpie", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/010.png","Bug","","Caterpie memiliki selera makan yang rakus. Ini bisa melahap daun lebih besar dari tubuhnya tepat di depan mata Anda. Dari antenanya, Pokemon ini mengeluarkan bau yang sangat kuat."},
            {"Metapod", "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/011.png","Bug","","Shell yang menutupi tubuh Pokemon ini sekeras lempengan besi. Metapod tidak banyak bergerak. Tetap diam karena sedang mempersiapkan jeroan lunak untuk evolusi di dalam cangkang keras."},
